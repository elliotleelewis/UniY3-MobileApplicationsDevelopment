...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(
        ...
        guard let tab = window?.rootViewController as? UITabBarController else { return true }
        let admin = tab.viewControllers?.last as? AdminSplitViewController
        let adminMasterNavigation = admin?.viewControllers.first as? UINavigationController
        let adminMaster = adminMasterNavigation?.viewControllers.first as? AdminMasterViewController
        let adminDetail = admin?.viewControllers.last as? AdminDetailViewController
        adminMaster?.delegate = adminDetail
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Assignment___iOS___Questionnaire")
